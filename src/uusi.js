...
var w1 = [11, 12, 13, 14, 15];
var w2 = [21, 22, 23, 24, 25];
var w3 = [31, 32, 33, 34, 35];
var w4 = [41, 42, 43, 44, 45];
var w5 = [51, 52, 53, 54, 55];

var w6 = [11, 21, 31, 41, 51];
var w7 = [12, 22, 32, 42, 52];
var w8 = [13, 23, 33, 53, 53];
var w9 = [14, 24, 34, 44, 54];
var w10 = [15, 25, 35, 45, 55];

var w11 = [11, 22, 33, 44, 55];
var w12 = [51, 24, 33, 42, 15];

var wAll = [w1, w2, w3, w4, w5, w6, w7, w8, w9, w10, w11, w12];

function testWin(player) {
  // ALL winning combinations to single combination
  for (var k in wAll) {
    var voittokombinaatio = wAll[k]; // single winning combination
    console.log("voittokombinaatio ", voittokombinaatio);
    var osumat = 0;

    // single winning combination to winning number
    for (var j in voittokombinaatio) {
      var voittosolu = voittokombinaatio[j]; // Winning number
      console.log("voittosolu ", voittosolu);
      var i;

      //  All numbers that player has to single number
      for (i in player) {
        var solu = player[i]; // Single number
